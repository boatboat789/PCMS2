...
public class SwitchProdOrderDetail {
	...
	public SwitchProdOrderDetail(String saleOrder, String saleLine, String productionOrder, String saleOrderSW, String saleLineSW,
			String productionOrderSW, String changeBy, String changeDate) {
		super();

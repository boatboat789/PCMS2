...
import th.co.wacoal.atech.pcms2.service.PCMSDetailV2Service;
...
@Controller
@RequestMapping(value = { "/DetailV2" })
public class PCMSDetailV2Controller {
	private final PCMSDetailV2Service pcmsDetailService;
	...
	@Autowired
	public PCMSDetailV2Controller(PCMSDetailV2Service pcmsDetailService, UserStatusDetailService usdService
		...
		if (user != null) {
			...
			if (permit == null) {
				...
				if (permit.isPCMSMain()) {
					...
					mv.setViewName("PCMSDetail/PCMSDetailV2");
...
//	public void doGetSearchByDetail(
//	        HttpServletResponse response,
//	        @RequestBody PCMSDetailSearchRequest req) throws IOException {
//
//	    Gson g = new Gson();
//	    response.setContentType("application/json");
//	    PrintWriter out = response.getWriter();
//
//	    DataTableResponse<PCMSSecondTableDetail> result =
//	        pcmsDetailService.searchByDetail(req.getCriteria(),
//	                                         req.getStart(),
//	                                         req.getLength());
//

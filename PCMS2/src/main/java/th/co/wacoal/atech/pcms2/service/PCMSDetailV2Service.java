...
@Service
public class PCMSDetailV2Service {  
	private PCMSDetailV2Dao dao; 

	@Autowired
	public PCMSDetailV2Service(PCMSDetailV2Dao dao ) { 
			this.dao = dao;  
	} 
	...
	public DataTableResponse<PCMSSecondTableDetail> searchByDetail(ArrayList<PCMSTableDetail> poList, int i, int j)
	{
		// TODO Auto-generated method stub
		DataTableResponse<PCMSSecondTableDetail> list = this.dao.searchByDetail(poList,  i,  j);
		return list;
	}

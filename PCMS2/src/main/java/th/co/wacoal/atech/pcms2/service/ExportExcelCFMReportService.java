...
public class ExportExcelCFMReportService {
	...
	private static final String[] HEADERS = { "Send Date", "No Per Day", "Reply Date", "CFM No", "Customer Name", "SO", "SO Line",
			"Due Date", "PO", "Material", "Product Name", "Lab No", "Color", "Prod ID", "Lot No", "Dye L", "Dye Da", "Dye Db",
			"Dye St", "Dye DeltaE", "Color Check L", "Color Check Da", "Color Check Db", "Color Check St", "Color Check DeltaE",
			"CFM L", "CFM Da", "CFM Db", "CFM St", "CFM DeltaE", "Color Check Date", "Color Check Status", "Color Check Remark",
			"Result", "QC Comment", "Remark From Submit", "Next Lot", "Qty", "Unit Id" };

	// Corresponding Java field names (must match your entity)
	private static final String[] FIELDS = { "sendDate", "noPerDay", "replyDate", "cfmNo", "customerName", "so", "soLine",
			"dueDate", "po", "material", "productName", "labNo", "color", "prodID", "lotNo", "dyeL", "dyeDa", "dyeDb", "dyeSt",
			"dyeDeltaE", "colorCheckL", "colorCheckDa", "colorCheckDb", "colorCheckSt", "colorCheckDeltaE", "cfmL", "cfmDa",
			"cfmDb", "cfmSt", "cfmDeltaE", "colorCheckDate", "colorCheckStatus", "colorCheckRemark", "result", "qcComment",
			"remarkFromSubmit", "nextLot", "qty", "unitId" };

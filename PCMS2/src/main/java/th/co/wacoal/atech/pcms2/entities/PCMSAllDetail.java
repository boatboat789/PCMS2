...
//	  private ArrayList<WaitTestDetail> waitTestDetailList;
	...
	public PCMSAllDetail(String productionOrder, String lotNo, String batch, String labNo, String prdCreateDate, String dueDate,
			String saleOrder, String saleLine, String purchaseOrder, String articleFG, String designFG, String customerName,
			String customerShortName, String shade, String bookNo, String center, String materialNo, String volumn,
			String saleUnit, String sTDUnit, String color, String planGreigeDate, String refPrd, String greigeInDate,
			String bCAware, String orderPuang, String userStatus, String labStatus, String cFMDatePlan, String DeliveryDate,
			String bCDate, String remarkOne, String remarkTwo, String remarkThree, String remAfterCloseOne,
			String remAfterCloseTwo, String remAfterCloseThree, String GreigeArticle, String GreigeDesign, String ColorCustomer) {
		super();

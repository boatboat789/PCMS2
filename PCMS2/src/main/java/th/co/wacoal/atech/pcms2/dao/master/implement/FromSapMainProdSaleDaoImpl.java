...
//	private BeanCreateModel bcModel = new BeanCreateModel();
	...
	public String upsertFromSapMainProdSaleDetail(ArrayList<FromErpMainProdSaleDetail> paList) {
	    ...
	    try {
	        iconStatus = this.jdbc.execute((ConnectionCallback<String>) conn -> {
	            ...
	            try (Statement stmt = conn.createStatement()) {
	                ...
	                try (PreparedStatement ps = conn.prepareStatement(insertTemp)) {
	                    ...
	                    for (FromErpMainProdSaleDetail bean : paList) {
	                        ...
	                        sshUtl.setSqlBigDecimal(ps, bean.getVolumn(), idx++);
	        ...
	        log.error("[ERP-sync] upsertFromSapMainProdSaleDetail failed", e);
	        iconStatus = "E";
	    }
	    return iconStatus;
	}

...
//			+ "	  ,( a.SaleQuantity - a.RemainQuantity ) as BillQuantity\r\n" 
	...
	private String selectWaitLot = 
	  		    "  a.SaleOrder 		, CASE PATINDEX('%[^0 ]%', a.[SaleLine]  + ' ‘')\r\n"
	  		    + "		WHEN 0 THEN ''  \r\n"
	  		    + "		ELSE SUBSTRING(a.[SaleLine] , PATINDEX('%[^0 ]%', a.[SaleLine]  + ' '), LEN(a.[SaleLine] ) )\r\n"
	  		    + "		END AS [SaleLine]    ,CASE PATINDEX('%[^0 ]%', a.[SaleNumber]  + ' ‘') \r\n"
	  		    + "    		 WHEN 0 THEN ''   \r\n"
	  		    + "    		 ELSE SUBSTRING(a.[SaleNumber] , 5, LEN(a.[SaleNumber])) +':'+a.[SaleFullName]\r\n"
	  		    + "    		 END AS [SaleFullName]   \r\n"
	  		    + ", a.DesignFG\r\n"
	  		    ...
	  		    + ", DyeStatus  \r\n"
	  		    + ", h.DeliveryDate \r\n"
	  		    + ", LabNo,a.CustomerName,a.CustomerShortName,a.SaleNumber\r\n"
	  		    + ",a.SaleCreateDate,  PrdCreateDate\r\n"
...
//				+ this.leftJoinUCAL 
				...
				+ " and ( b.SumVol <> 0 \r\n"
				+ "		or ( (  b.ProductionOrder = 'รอจัด Lot'  or  b.ProductionOrder = 'ขาย stock'  or b.ProductionOrder = 'รับจ้างถัก' or b.ProductionOrder = 'Lot ขายแล้ว' )  and b.SumVol = 0  \r\n"
...
//		System.out.println("Before SQL:  AFTER SQL LIST: "+new Date());

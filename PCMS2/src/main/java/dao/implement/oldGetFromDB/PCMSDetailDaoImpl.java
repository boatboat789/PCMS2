//package dao.implement.oldGetFromDB;
//
...
//    		+ " left join [PCMS].[dbo].[TEMP_UserStatusAuto] as UCAL on \r\n"
//    		+ "            b.ProductionOrder = UCAL.ProductionOrder AND (  m.Grade = UCAL.Grade OR  m.Grade IS NULL )  \r\n"; 
//    			private String leftJoinUCALRP = "    "
//    		+ " left join [PCMS].[dbo].[TEMP_UserStatusAuto] as UCALRP on b.ProductionOrder = UCALRP.ProductionOrder "

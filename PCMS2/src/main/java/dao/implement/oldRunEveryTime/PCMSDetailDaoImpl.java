//package dao.implement.oldRunEveryTime;
//
...
//  		    "a.SaleOrder \r\n"
//  		  + ", CASE PATINDEX('%[^0 ]%', a.[SaleLine]  + ' ‘') WHEN 0 THEN '' ELSE SUBSTRING(a.[SaleLine] , PATINDEX('%[^0 ]%', a.[SaleLine]  + ' '), LEN(a.[SaleLine] ) ) END AS [SaleLine] \r\n"
//  		  + ", Division\r\n"
//  		  + ", CustomerShortName\r\n"
//  		  + ", SaleCreateDate\r\n"
//  		  + ", PurchaseOrder\r\n"
...
//    		+ "g.SendCFMCusDate, \r\n"
//    		+ "CASE WHEN h.[ProductionOrder] is not null THEN H.DeliveryDate ELSE b.CFTYPE END AS DeliveryDate , \r\n"
////    		+ "d.CFMSendDate,\r\n" 
////    		+ "d.CFMAnswerDate,\r\n" 
////      		+ "d.CFMStatus,\r\n" 
////      		+ "d.CFMNumber,\r\n" 
...
//  		+ "b.SendCFMCusDate,\r\n"
//  		+ "CASE WHEN b.[ProductionOrder] is not null THEN b.DeliveryDate ELSE b.CFTYPE END AS DeliveryDate , \r\n"
////  		+ "d.CFMSendDate,\r\n" 
////  		+ "d.CFMAnswerDate,\r\n" 
////  		+ "d.CFMStatus,\r\n" 
////  		+ "d.CFMNumber,\r\n" 
...
//			  + "            , g.[SendCFMCusDate] , g.[DyeStatus] , h.DeliveryDate, 	UCAL.UserStatusCal as UserStatus 		\r\n"
...
////	  		  + "	   ,  STUFF((\r\n"
////	  		  + "				SELECT ' ,' +c.[CFMNo]+'. '+ --c.[CFMNumber]+' | '+\r\n"
////	  		  + "				CAST( c.[CFMSendDate] AS VARCHAR) +' | '+\r\n"
////	  		  + "				CAST( c.[CFMAnswerDate] AS VARCHAR)+' | '+c.[CFMStatus]--+' | '+c.[RollNoRemark]\r\n"
////	  		  + "				FROM [PCMS].[dbo].[FromSapCFM] as c\r\n"
////	  		  + "				WHERE a.ProductionOrder = c.ProductionOrder and c.DataStatus = 'O'\r\n"
////	  		  + "				FOR XML PATH('')\r\n"
////	  		  + "				), 1, 2, '') as CFMDetailAll\r\n"

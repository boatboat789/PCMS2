...
//			+ " declare @StockDateLast NVARCHAR(2) = '25' ; \r\n"
			...
			+ "				CAST( year(@BeginDateFourth) as NVARCHAR(4)) \r\n"
			+ "				,RIGHT('00' + cast(month(@BeginDateFourth) as NVARCHAR(2)),2)\r\n"
			+ "				 ,@StockDateLast\r\n"
			+ "				 );   ; \r\n"
			...
			+ "				CAST( year(@BeginDateFifth) as NVARCHAR(4)) \r\n"
			+ "				,RIGHT('00' + cast(month(@BeginDateFifth) as NVARCHAR(2)),2)\r\n"
			+ "				 ,@StockDateLast\r\n"
			+ "				 );  ;  \r\n"
			...
			+ "				CAST( year(@BeginDateSixth) as NVARCHAR(4)) \r\n"
			+ "				,RIGHT('00' + cast(month(@BeginDateSixth) as NVARCHAR(2)),2)\r\n"
			+ "				 ,@StockDateLast\r\n"
			+ "				 );  ;  \r\n"
...
//				+ this.decalreTempGroupWorkDate
				...
				+ "	TotalNonBLQty ,\r\n"
				+ "	TotalAllCapQty )\r\n"
				+ "	  values( @BeginFirstMonth , @LastFirstMonth ,RIGHT('00' + cast(month(@BeginDateFirst) as NVARCHAR(2)),2) +'/'+CAST( year(@BeginDateFirst) as NVARCHAR(4))\r\n"
				+ "	  , @FirstTotalDays\r\n"
				+ "	  , ISNULL(  (  \r\n"
				+ "		 SELECT   \r\n"
				...
				+ "		, @LastSecondMonth,RIGHT('00' + cast(month(@BeginDateSecond) as NVARCHAR(2)),2) +'/'+CAST( year(@BeginDateSecond) as NVARCHAR(4)) \r\n"
				+ "	    , @SecondTotalDays\r\n"
				+ "	    , ISNULL(  (  \r\n"
				+ "		 SELECT   \r\n"
				...
				+ "	TotalNonBLQty,\r\n"
				+ "	TotalAllCapQty  )\r\n"
				+ "	  values( @BeginThirdMonth , @LastThirdMonth,RIGHT('00' + cast(month(@BeginDateThird) as NVARCHAR(2)),2) +'/'+CAST( year(@BeginDateThird) as NVARCHAR(4))  \r\n"
				+ "	    , @ThirdTotalDays\r\n"
				+ "	  , ISNULL(  (  \r\n"
				+ "		 SELECT   \r\n"

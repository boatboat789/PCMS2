...
//			+ "			else ( SELECT [DayOfMonth] FROM [PPMM].[dbo].[StockDefaultDate] where [DataStatus] ='O' )\r\n"
	...
	private String selectPO = ""
			...
			+ "       ,a.[DyeAfterGreigeInLast]\r\n"
			+ "       ,a.[LastCFMDate]\r\n"
			+ "       ,cast([FirstLotGroupNo] as varchar) as [FirstLotGroupNo]\r\n"
			+ "       ,cast([FirstLotSubGroup] as varchar) as [FirstLotSubGroup]\r\n"
			+ "       ,a.[TempPlanningId]\r\n"
			+ "	      ,case \r\n"
			...
			+ "	      ,a.[POPuangId]\r\n"
			+ "       ,CAST(NULL AS varchar) as ForecastMY\r\n"
	...
	private String selectFC = ""
			...
			+ "       ,a.[LastCFMDate]\r\n"
			+ "       ,CAST(NULL AS varchar) as [FirstLotGroupNo]\r\n"
			+ "       ,CAST(NULL AS varchar) as [FirstLotSubGroup]\r\n"
			+ "       ,A.[TempPlanningId] \r\n "
			+ "       ,case \r\n"
			+ "          when MaxLTDeliveryDate > a.[ForecastDateMonthLast] then  CONVERT(Bit, 'True')\r\n"
			+ "          else CONVERT(Bit, 'False')\r\n"
			+ "          END AS isOverDue\r\n"
			+ "       ,CAST(NULL AS varchar) as GroupBegin\r\n"
			+ "       ,CAST(NULL AS int) as [Operation] \r\n"
			+ "       ,CAST(NULL AS varchar) as [MaterialNo]\r\n"
			+ "       ,a.ForecastNo as [PO]\r\n"
			+ "       ,'' as [POLine]\r\n"
			+ "       ,CAST(NULL AS varchar) as isInSap\r\n"
			...
			+ "       ,CAST(NULL AS varchar) as POIdInstead\r\n"
//			+ "       ,LFL.POIdInstead\r\n"
...
//			+ "	   ,  isSabina\r\n"
	...
	private String selectRDE = " "
			...
			+ "       ,a.[ColorType]\r\n"
			+ "       ,a.[ProductionOrder]\r\n"
			+ "       ,CAST(NULL AS varchar) as [FirstLot]\r\n"
			+ "       ,CAST(a.[QuantityMR] as decimal(13,3))  as [ProdOrderQty]\r\n"
			+ "       ,CAST(NULL AS varchar) as [PPMMStatus]\r\n"
			+ "       ,CAST(NULL AS varchar) as [DataStatus]\r\n"
			+ "       ,CAST(NULL AS varchar) as [ChangeDate]\r\n"
			+ "       ,CAST(NULL AS varchar) as [ChangeBy] \r\n"
			+ "       ,a.[ColorCustomer] \r\n"
			+ "       ,[FGDesign] AS [Design]\r\n"
			+ "       ,a.[CustomerDue]\r\n"
			+ "       ,a.[Article]\r\n"
			...
			+ "       ,CAST(NULL AS varchar) as [POUnit]\r\n"
			+ "       , CPP.IsExpired  \r\n"
			+ "       , PriorDistChannal\r\n"
			+ "       , PresetEndDate\r\n"
			+ "       , 1 as isRedye\r\n"
...
//			+ "    , isSabina\r\n"
	...
	private String declarePPMMPOAdd = ""
			...
			+ " ,RDD.[LastCFMDate]\r\n"
			+ " ,cast(null as date)  as FirstLotDate\r\n"
			+ " ,cast(null as varchar(50) ) as FirstLotGroupNo\r\n"
			+ " ,cast(null as varchar(50) ) as FirstLotSubGroup\r\n"
			+ " ,rdd.FirstLot\r\n"
			+ " ,rdd.DyeAfterCFM\r\n"
			+ " ,rdd.DueDate\r\n"
			+ " ,rdd.[DueDate] as ForSortDueAndCustDue\r\n"
...
//			+ "		 and ( SPDC.[DataStatus] = 'O' OR SPDC.[DataStatus] IS NULL )\r\n"
	...
	private String declareFC = ""
			...
			+ ",[GroupOptions] \r\n"
			+ ",[PPMMStatus] \r\n"
			+ "	,CAST(  ROW_NUMBER() OVER ( PARTITION BY [ForecastId]  ORDER BY [ForecastId] , [ProductionOrder] )as varchar(max))  as [BatchFirst] \r\n"
			+ " into #tempFCDate \r\n"
...
//			+ "	   ,  isSabina\r\n"
	...
	private String declareFCForShowOnly = ""
			...
			+ "                 ORDER BY [ForecastId], A.[ProductionOrder] ) as varchar(max)) as [BatchFirst] \r\n"
			+ " into #tempFCTempProd\r\n"
			+ " FROM [PPMM].[dbo].[SOR_TempProd] as a\r\n"
			+ " INNER join [PPMM].[dbo].[TEMP_PlanningLot] as c on a.id = c.TempProdId  \r\n"
...
//		dragLotBean.getProductionOrder();
	...
	public ArrayList<InputGroupDetail> getMainSubGroupQtyForSetDate(InputTempProdDetail bean)
	{
		...
		String sql = " "
				...
				+ "					END AS LotQtyMin\r\n"
				+ "				, CASE \r\n"
				+ "					WHEN OverCapQty is null or OverCapQty = '' or OverCapQty = '0' then CAST(A.LotMinMax AS varchar)\r\n"
				+ "					else CAST(A.LotMinMax AS varchar)+' ( '+CAST(A.OverCapQty AS varchar)+' )'\r\n"
				+ "					end AS GroupWithQty\r\n"
				+ "			FROM [PPMM].[dbo].[InputArticleSubGroupDetail]  AS A \r\n"
				+ "				where ( A.[DataStatus] = 'O' )  \r\n"

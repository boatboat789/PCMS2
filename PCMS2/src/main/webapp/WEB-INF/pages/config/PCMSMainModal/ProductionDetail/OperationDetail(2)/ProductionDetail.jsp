<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>       
 <div class="tab-pane fade" id="nav-ProductionDetail_2" style=" height: -webkit-fill-available;min-height: 100%;"  role="tabpanel" aria-labelledby="nav-ProductionDetail_2-tab">
	<div class="row" style="margin: 10px;" >              
  
		<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 " >
			<div class="row"  >    
				<div class="col-12 	col-sm-12 col-md-12 col-lg-12 col-xl-12 inspectWrapper  " style="display: inline-flex;
				 			 text-align: right;"> 
<!-- 				 	<label class="my-1 mr-2 " for="input_bookNoCNF">Inspect</label>            -->
...
<!-- 				</div>         -->
		...
		<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 " >
			<div class="row"  >     
			  	 <div class="col-12 	col-sm-12 col-md-12 col-lg-12 col-xl-12 packingWrapper " style="display: inline-flex;
				 			 text-align: right;"> 
<!-- 				 	<label class="my-1 mr-2 " for="input_bookNoCNF">Packing</label>            -->  
			  	 	<div class="table-responsive ">

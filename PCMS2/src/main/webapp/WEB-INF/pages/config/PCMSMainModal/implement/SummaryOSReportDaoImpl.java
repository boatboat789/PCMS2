...
//				+ " declare @StockDateLast NVARCHAR(2) = '25' ; \r\n"
				...
				+ "     ,CAST( @BeginFirstMonth AS NVARCHAR )	+' - '+CAST(@LastFirstMonth AS NVARCHAR) as FirstMonth\r\n"
				+ "		,CAST( @BeginSecondMonth AS NVARCHAR)+' - '+CAST( @LastSecondMonth AS NVARCHAR) as SecondMonth\r\n"
				+ "	 	,CAST( @BeginThirdMonth AS NVARCHAR)+' - '+CAST( @LastThirdMonth AS NVARCHAR) as ThirdMonth\r\n"

...
<%-- 	<script src="<c:url value="/resources/vendor/sweetalert2-11.1.7/package/dist/sweetalert2.min.js"/>"></script>  --%>
	<script src="<c:url value="/resources/vendor/dateRangePicker/daterangepicker.js"/>"></script>  
<%--     <link href="<c:url value="/resources/vendor/sweetalert2-11.1.7/package/dist/sweetalert2.min.css" />"  --%>
...
<%--   <link  href="<c:url value="/resources/vendor/jquery/jquery-ui-1.12.1/jquery-ui.css" />" rel="stylesheet" type="text/css"> --%>